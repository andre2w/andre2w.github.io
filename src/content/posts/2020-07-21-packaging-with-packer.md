...
published: 2020-07-21 00:00:00 +00:00
...
```json
{
  "provisioners": [
    ...
    {
      "type": "shell",
      "inline": ["sudo apt update -y", "sudo apt install -y chrony openjdk-11-jre-headless"]
    },
    {
      "type": "shell",
      "inline": [
...
```json
{
  ...
  "builders": [
    ...
    },
    {
      ...
      "image": "ubuntu:18.04",
      "commit": true,
      "changes": ["LABEL mantainer.name='Andre Torres'", "EXPOSE 8080"]
    }
  ]
}
```
...
```json
{
  "provisioners": [
    ...
    {
      "type": "shell",
      "inline": ["sudo apt-get update -y", "sudo apt-get install -y chrony openjdk-11-jre-headless"]
    },
    {
      "type": "shell",
      "inline": [
...
```json
{
  ...
  "sensitive-variables": ["docker_hub_password"],
  "builders": [
    {
      "type": "amazon-ebs",
      "access_key": "{{user `aws_access_key`}}",
...
```json
{
  ...
  "provisioners": [
    ...
    {
      "type": "shell",
      "inline": ["sudo apt-get update -y", "sudo apt-get install -y chrony"]
    },
    {
      "type": "shell",
      "inline": [
...
```json
{
  ...
  "provisioners": [
    ...
    {
      "type": "shell",
      "inline": ["sudo apt-get update -y", "sudo apt-get install -y openjdk-11-jre-headless"]
    }
  ],
  "post-processors": [
    [
